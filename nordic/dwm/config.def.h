...
// Nordic-inspired dark palette
static const char col_base[]        = "#2e3440"; // Main dark background
static const char col_text[]        = "#ebcb8b"; // Light foreground
static const char col_subtext[]     = "#D8DEE9"; // Muted subtext
static const char col_accent[]      = "#81A1C1"; // Nordic accent blue

static const char *colors[][3]      = {
	/*               fg            bg         border   */
	[SchemeNorm]     = { col_subtext, col_base, "#000000" },      // border stays #000000
	[SchemeSel]      = { col_text,    col_base, col_accent  },
	[SchemeStatus]   = { col_subtext, col_base, "#000000"   },
	[SchemeTagsSel]  = { "#EBCB8B",   col_base, "#000000"   },    // nord yellow accent
	[SchemeTagsNorm] = { col_subtext, col_base, "#000000"   },
	[SchemeInfoSel]  = { col_text,    col_base, "#000000"   },
	[SchemeInfoNorm] = { col_subtext, col_base, "#000000"   },
};
