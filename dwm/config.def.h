...
static const char *colors[][3]      = {
	/*               fg            bg         border   */
	[SchemeNorm]     = { col_subtext, col_base, col_subtext },
	[SchemeSel]      = { col_text,    col_base, col_accent  },
	[SchemeStatus]   = { col_subtext, col_base, "#000000"   }, // Statusbar right {text,background,not used but cannot be empty}
	[SchemeTagsSel]  = { "#eed49f",    col_base, "#000000"   }, // Tagbar left selected {text,background,not used but cannot be empty}
	[SchemeTagsNorm] = { col_subtext, col_base, "#000000"   }, // Tagbar left unselected {text,background,not used but cannot be empty}
	[SchemeInfoSel]  = { col_text,    col_base, "#000000"   }, // infobar middle  selected {text,background,not used but cannot be empty}
	[SchemeInfoNorm] = { col_subtext, col_base, "#000000"   }, // infobar middle  unselected {text,background,not used but cannot be empty}
};
